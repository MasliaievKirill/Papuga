...
import com.masliaiev.core.ui.InformationCard
import com.masliaiev.core.ui.Track
...
private fun PlaylistScreenContent(
    ...
    LaunchedEffect(key1 = Unit) {
        onUiEvent(
            PlaylistUiEvent.LoadPlaylist(playlistId)
        )
    }
    ...
    Scaffold(
        ...
        topBar = {
            LargeTopAppBar(
                title = {
                    Text(
                        text = playlist?.title ?: EmptyConstants.EMPTY_STRING,
        ...
        playlist?.let {
            Box(
                ...
                LazyColumn(
                            ...
                            Row(
                                ...
                                InformationCard(
                                    ...
                                    text = stringResource(
                                        ...
                                        playlist.fansCount ?: EmptyConstants.EMPTY_STRING
                                    ),
                                    color = Purple80,
                    ...
                    itemsIndexed(playlist.tracks.data) { index, track ->
                        Track(
                            track = track,
                            index = index,
                            onClick = {
